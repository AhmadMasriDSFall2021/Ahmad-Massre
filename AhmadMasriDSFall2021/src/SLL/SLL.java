        ...
        if(isEmpty()){
            ...
            while(currentNode!=null){
                if(currentNode.getNext()==null)
                    return list1.getTailNode().setValue(list1.getHeadNode().getValue());
            }
        }
        
    }
    public void union(SLL list1,SLL list2){
         if (list1.isEmpty() && list2.isEmpty()) {
            throw new RuntimeException();
        }
         Node currentNode = this.head;
         while(currentNode != null){
             list1.getTailNode().setNext(list2.getHeadNode().getNext());
         }
